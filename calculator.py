...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_fifth.addWidget(self.b_mul)

        self.b_div = QPushButton("/", self)
        self.hbox_fifth.addWidget(self.b_div)

        self.b_backspace = QPushButton("<-", self)
        self.hbox_result.addWidget(self.b_backspace)
        ...
        self.b_backspace.clicked.connect(lambda: self._button("<-"))
        self.b_del.clicked.connect(lambda: self._button("del"))
